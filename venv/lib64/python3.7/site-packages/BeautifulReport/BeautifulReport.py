...
class BeautifulReport(ReportTestResult, PATH):
    # d = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))),'img','error_img')
    # print(d)
    # abspath = os.path.abspath(d)
    path = '/root/PycharmProjects/blr.9161252.com/img/error_img'
    # d = os.path.join(path, 'img',
    #                  'error_img')
    abspath = os.path.abspath(path)
    img_path = abspath if platform.system() != 'Windows' else abspath
